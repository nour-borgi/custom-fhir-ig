...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationDispense">
      <sch:assert test="count(f:extension[@url = 'http://cdr.com/dose-end-date']) &lt;= 1">extension with URL = 'http://cdr.com/dose-end-date': maximum cardinality of 'extension' is 1</sch:assert>
