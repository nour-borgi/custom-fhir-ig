...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Encounter">
      <sch:assert test="count(f:extension[@url = 'http://cdr.com/next-visit']) &lt;= 1">extension with URL = 'http://cdr.com/next-visit': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://cdr.com/visit-type']) &lt;= 1">extension with URL = 'http://cdr.com/visit-type': maximum cardinality of 'extension' is 1</sch:assert>
