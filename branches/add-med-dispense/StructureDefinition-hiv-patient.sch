...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      <sch:assert test="count(f:extension[@url = 'http://openhie.org/fhir/custom-fhir-ig/StructureDefinition/client-key-population-extension']) &lt;= 1">extension with URL = 'http://openhie.org/fhir/custom-fhir-ig/StructureDefinition/client-key-population-extension': maximum cardinality of 'extension' is 1</sch:assert>
